...
import { deleteExpense } from "@amaneq/core";
...
export function ExpenseTable({ tripId, expenses, onDeleted }: ExpenseTableProps) {
            ...
            <TableRow key={expense.id}>
              ...
              <TableCell>
                <Badge variant="outline">
                  {(expense.category && categoryLabels[expense.category]) ??
                    expense.category ??
                    "その他"}
                </Badge>
              </TableCell>
