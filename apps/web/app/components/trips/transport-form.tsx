...
export function TransportForm({ tripId, maxDay, items, editItem, open: controlledOpen, onOpenChange }: TransportFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const carNumber = (formData.get("carNumber") as string) || null;
    ...
    try {
      if (editItem) {
        ...
        await updateItineraryItem(client, editItem.id, {
          title: titleValue,
          description,
          departure_name: departureName || null,
          arrival_name: arrivalName || null,
        ...
        await createItineraryItem(client, {
          ...
          p_departure_name: departureName || null,
          p_arrival_name: arrivalName || null,
      ...
      console.error("Failed to save transport item:", err);
    } finally {
      setSubmitting(false);
    }
  }
